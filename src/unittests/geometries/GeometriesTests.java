...
class GeometriesTests {
	...
	void testFindIntersections() {
		...
		Assertions.assertEquals(3, result.size(), "Error: need 3 intersections");

		// =============== Boundary Values Tests ==================
		// TC02: Ray does not intersect with any geometries (0 points)
		Assertions.assertNull(geos.findIntersections(new Ray(new Point(0, 2, 0), new Vector(-1, 0, 0))),
		...
		Assertions.assertEquals(1, result.size(), "Error: need 1 intersections");

		// TC04: Empty Geometries (0 points)
		geos = new Geometries();
		Assertions.assertNull(geos.findIntersections(new Ray(new Point(1, 0, 1), new Vector(1, 0, 2))),
				"Error: need 0 intersections");
		...
		Assertions.assertEquals(4, result.size(), "There should be four intersections");
